...
// node_modules/react-imask/esm/_rollupPluginBabelHelpers-2cac7098.js
...
var MASK_PROPS = {
  ...
  signed: import_prop_types.default.bool,
...
var MASK_OPTIONS_PROPS_NAMES = MASK_PROPS_NAMES.filter((pName) => NON_MASK_OPTIONS_PROPS_NAMES.indexOf(pName) < 0);
function IMaskMixin(ComposedComponent) {
  const MaskedComponent = class extends import_react.default.Component {
    constructor(props) {
      super(props);
    ...
    initMask() {
      let maskOptions = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this._extractMaskOptionsFromProps(this.props);
    ...
    render() {
      return import_react.default.createElement(ComposedComponent, Object.assign({}, this._extractNonMaskProps(this.props), {
  ...
  return import_react.default.forwardRef((props, ref) => import_react.default.createElement(MaskedComponent, Object.assign({}, props, {
    ref
  })));
}
...
var _excluded6 = ["inputRef"];
var IMaskInputClass = IMaskMixin((_ref) => {
  let {
    inputRef
  } = _ref, props = _objectWithoutPropertiesLoose2(_ref, _excluded6);
  return import_react2.default.createElement("input", Object.assign({}, props, {
    ref: inputRef
  }));
});
var IMaskInputFn = (props, ref) => (
  // TODO type
  import_react2.default.createElement(IMaskInputClass, Object.assign({}, props, {
    ref
  }))
);
...
var _excluded23 = ["unmaskedValue"];
var _excluded32 = ["typedValue"];
function useIMask(opts) {
  ...
  const _onComplete = (0, import_react3.useCallback)(() => maskRef.current && (onComplete === null || onComplete === void 0 ? void 0 : onComplete(maskRef.current.value, maskRef.current)), [onComplete]);
  ...
  (0, import_react3.useEffect)(() => {
    ...
    } = lastAcceptState, state = _objectWithoutPropertiesLoose2(lastAcceptState, _excluded7);
    const mask = maskRef.current;
    if (mask && initialized && lastAcceptValue !== value)
      mask.value = value;
  ...
  (0, import_react3.useEffect)(() => {
    ...
    } = lastAcceptState, state = _objectWithoutPropertiesLoose2(lastAcceptState, _excluded23);
    const mask = maskRef.current;
    if (mask && initialized && lastAcceptUnmaskedValue !== unmaskedValue)
  ...
  (0, import_react3.useEffect)(() => {
    ...
    } = lastAcceptState, state = _objectWithoutPropertiesLoose2(lastAcceptState, _excluded32);
    const mask = maskRef.current;
    if (mask && initialized && lastAcceptTypedValue !== typedValue)
